...
def spatial_O(i):
    ...
    pickle_file_path = Path(f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_aux/spatial_O_2_results/{i}/all_data.pkl')
    ...
    path = f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_aux/spatial_O_3'
