...
def spatial_CR(i):
    ...
    #----------------------------------------------------------------------------------------------------------------------
    # import spatial part
    pickle_file_path_sp = Path(f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_spatial/spatial_SR_4_results/{i}/all_data.pkl')

    with open(pickle_file_path_sp, 'rb') as file:
    ...
    path = f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_spatial/spatial_SR_5'
    ...
    R_space_ig = data_old['current_R']
    N0_space   = data_old['current_N']
    biomass = data_old['biomass']  
    ...
    data['current_N']       = current_N
    data['g_rates']         = g_rates
    data['s_list']          = data_old['s_list'] + s_list[0::50]
    data['abundances']      = data_old['abundances'] + abundances[0::50]
    data['t_list']          = data_old['t_list'] + t_list[0::50]
    data['biomass']         = biomass
