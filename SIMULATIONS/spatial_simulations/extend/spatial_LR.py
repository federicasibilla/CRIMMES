...
def spatial_CR(i):
    ...
    #----------------------------------------------------------------------------------------------------------------------
    # import spatial part
    pickle_file_path_sp = Path(f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_spatial/spatial_LR_results/{i}/all_data.pkl')
    ...
    path = f'/work/FAC/FBM/DMF/smitri/nccr_microbiomes/federica/extend_spatial/spatial_LR_3'
